<template>
  <main class="wrapper">
    <section
      id="privacy"
      class="section section-pivacy">
      <h1 class="heading heading-privacy">Datenschutzerklärung</h1>
      <article>
        <p>Verantwortliche Stelle im Sinne der Datenschutzgesetze, insbesondere der EU-Datenschutzgrundverordnung (DSGVO), ist:</p>
        <p>melsicon GmbH</p>
        <h2 class="sub-heading">Ihre Betroffenenrechte</h2>
        ...
        <p>Hier finden Sie eine <a href="https://www.bfdi.bund.de/DE/Infothek/Anschriften_Links/anschriften_links-node.html">Liste der Aufsichtsbehörden</a> (für den nichtöffentlichen Bereich) mit Anschrift.</p>
      </article>
      <!-- ALLGEMEINE -->
      <article>
        <h2
          id ="general"
          class="sub-heading">Erfassung allgemeiner Informationen beim Besuch unserer Website</h2>
      ...
      <article>
        ...
        <p>Soweit Sie uns durch Ihre Browsereinstellungen oder Zustimmung die Verwendung von Cookies erlauben, können folgende Cookies auf unseren Webseiten zum Einsatz kommen:</p><p>Soweit diese Cookies (auch) personenbezogene Daten betreffen können, informieren wir Sie darüber in den folgenden Abschnitten.</p>
        ...
        <ul class="privacy-list">
          ...
          <li><a
            ...
            target="_blank"
            rel="nofollow noopener">Safari</a></li>
        </ul>
      </article>
      <!-- WEBSITE REGISTER -->
      <article>
        <h2
          if="register"
          class="sub-heading">Registrierung auf unserer Website</h2>
        <h3>Art und Zweck der Verarbeitung</h3>
      ...
      <article>
        <h2
          id="leistungen"
          class="sub-heading">Erbringung kostenpflichtiger Leistungen</h2>
        <h3>Art und Zweck der Verarbeitung</h3>
      ...
      <article>
        <h2
          id="commenting"
          class="sub-heading">Kommentarfunktion</h2>
        <h3>Art und Zweck der Verarbeitung</h3>
      ...
      <!-- CONTACT FORM -->
      <article>
        <h2 class="sub-heading">Kontaktformular</h2>
        <h3>Art und Zweck der Verarbeitung</h3>
      ...
      <!-- GOOGLE ANALYTICS -->
      <article>
        <h2 class="sub-heading">Verwendung von Google Analytics</h2>
        <h3>Art und Zweck der Verarbeitung</h3>
        ...
        <p>Google verarbeitet Ihre Daten in den USA und hat sich dem <a href="https://www.privacyshield.gov/EU-US-Framework">EU_US Privacy Shield</a> unterworfen. </p>
        <h3>Bereitstellung vorgeschrieben oder erforderlich</h3>
      ...
      <!-- GOOGLE FONTS -->
      <article>
        <h2 class="sub-heading">Verwendung von Scriptbibliotheken (Google Webfonts)</h2>
        <h3>Art und Zweck der Verarbeitung</h3>
        <p>Um unsere Inhalte browserübergreifend korrekt und grafisch ansprechend darzustellen, verwenden wir auf dieser Website „Google Web Fonts“ der Google LLC (1600 Amphitheatre Parkway, Mountain View, CA 94043, USA; nachfolgend „Google“) zur Darstellung von Schriften.</p>
        <p>Hier finden Sie die <a href="https://www.google.com/policies/privacy/">Datenschutzrichtlinie</a> des Bibliothekbetreibers Google.</p>
        <h3>Rechtsgrundlage</h3>
        ...
        <p>Weitere Informationen zu Google Web Fonts finden Sie unter <a href="https://developers.google.com/fonts/faq">Google Fonts FAQ</a> und in der <a href="https://www.google.com/policies/privacy/">Datenschutzerklärung</a> von Google.</p>
        <h3>Drittlandtransfer</h3>
        <p>Google verarbeitet Ihre Daten in den USA und hat sich dem <a href="https://www.privacyshield.gov/EU-US-Framework">EU_US Privacy Shield</a> unterworfen.</p>
        <h3>Bereitstellung vorgeschrieben oder erforderlich</h3>
      ...
      <!-- GOOGLE MAPS -->
      <article>
        <h2 class="sub-heading">Verwendung von Google Maps</h2>
        <h3>Art und Zweck der Verarbeitung</h3>
      ...
      <!-- YOUTUBE -->
      <article>
        <h2 class="sub-heading">Eingebettete YouTube-Videos</h2>
        <h3>Art und Zweck der Verarbeitung</h3>
        ...
        <p>Weitere Informationen zu Zweck und Umfang der Datenerhebung und ihrer Verarbeitung durch YouTube erhalten Sie in den <a href="https://policies.google.com/privacy">Datenschutzerklärungen des Anbieters</a>, Dort erhalten Sie auch weitere Informationen zu Ihren diesbezüglichen Rechten und Einstellungsmöglichkeiten zum Schutze Ihrer Privatsphäre. Google verarbeitet Ihre Daten in den USA und hat sich dem <a href="https://www.privacyshield.gov/EU-US-Framework">EU_US Privacy Shield</a> unterworfen.</p>
        <h3>Rechtsgrundlage</h3>
        ...
        <p>Weitere Informationen zum Datenschutz bei „YouTube“ finden Sie in der <a href="https://policies.google.com/privacy">Datenschutzerklärungen des Anbieters</a>.</p>
        <h3>Drittlandtransfer</h3>
        <p>Google verarbeitet Ihre Daten in den USA und hat sich dem <a href="https://www.privacyshield.gov/EU-US-Framework">EU_US Privacy Shield</a> unterworfen.</p>
        <h3>Bereitstellung vorgeschrieben oder erforderlich</h3>
        <p>Die Bereitstellung Ihrer personenbezogenen Daten erfolgt freiwillig, allein auf Basis Ihrer Einwilligung. Sofern Sie den Zugriff unterbinden, kann es hierdurch zu Funktionseinschränkungen auf der Website kommen.</p>
      ...
      <!-- GOOGLE REMARKETING -->
      <article>
        <h2 class="sub-heading">Einsatz von Google Remarketing</h2>
        <h3>Art und Zweck der Verarbeitung</h3>
        ...
        <p>Unser Unternehmen enthält keine Informationen von Google, mittels derer die betroffene Person identifiziert werden könnte.</p>
        <h3>Widerruf der Einwilligung</h3>
        <p>Nach eigenen Angaben erhebt Google bei diesem Vorgang keine personenbezogenen Daten. Sollten Sie die Funktion Remarketing von Google dennoch nicht wünschen, können Sie diese grundsätzlich deaktivieren, indem Sie die entsprechenden <a href="https://support.google.com/adwordspolicy/answer/143465">Einstellungen</a> vornehmen. Alternativ können Sie den Einsatz von Cookies für interessenbezogene Werbung über die Werbenetzwerkinitiative deaktivieren, indem Sie den <a href="http://www.networkadvertising.org/managing/opt_out.asp">Anweisungen</a> folgen.</p>
        <h3>Bereitstellung vorgeschrieben oder erforderlich</h3>
        <p>Die Bereitstellung Ihrer personenbezogenen Daten erfolgt freiwillig, allein auf Basis Ihrer Einwilligung. Sofern Sie den Zugriff unterbinden, kann es hierdurch zu Funktionseinschränkungen auf der Website kommen.</p>
      </article>
      <!-- SSL -->
      <article>
        <h2 class="sub-heading">SSL-Verschlüsselung</h2>
        <p>Um die Sicherheit Ihrer Daten bei der Übertragung zu schützen, verwenden wir dem aktuellen Stand der Technik entsprechende Verschlüsselungsverfahren (z. B. SSL) über HTTPS.</p>
      </article>
      <!-- CHANGES TO POLICY -->
      <article>
        <h2 class="sub-heading">Änderung unserer Datenschutzbestimmungen</h2>
        <p>Wir behalten uns vor, diese Datenschutzerklärung anzupassen, damit sie stets den aktuellen rechtlichen Anforderungen entspricht oder um Änderungen unserer Leistungen in der Datenschutzerklärung umzusetzen, z.B. bei der Einführung neuer Services. Für Ihren erneuten Besuch gilt dann die neue Datenschutzerklärung.</p>
      </article>
      <!-- QUESTIONS -->
      <article>
        <h2 class="sub-heading">Fragen an den Datenschutzbeauftragten</h2>
        ...
        <p><em>Die Datenschutzerklärung wurde mit dem </em><em><a
          ...
          target="_blank"
          rel="noopener">Datenschutzerklärungs-Generator der activeMind AG erstellt</a> (Version 2018-09-24).</em></p>
      </article>
    </section>
  </main>
</template>
...
export default {
  ...
  methods: {
    optOut() {
      Cookies.set('melsicon_cookie', false, { expires: 90 })
      window['ga-disable-UA-59119788-4'] = true
      window.ga('send', 'pageview')
    },
    optIn() {
      Cookies.set('melsicon_cookie', true, { expires: 90 })
      window['ga-disable-UA-59119788-4'] = false
      window.ga('send', 'pageview')
    }
  }
}
