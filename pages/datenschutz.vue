  ...
  <main class="wrapper">
    <section 
      ...
      <article class="article article-privacy">
        ...
        <h4>Bereitstellung vorgeschrieben oder erforderlich</h4>
        <p>Die Bereitstellung Ihrer personenbezogenen Daten erfolgt freiwillig, allein auf Basis Ihrer Einwilligung. Sofern Sie den Zugriff unterbinden, kann es hierdurch zu Funktionseinschränkungen auf der Website kommen.</p>
        <h3 class="sub-heading">Social Plugins</h3>
        <h4>Art und Zweck der Verarbeitung</h4>
        ...
        <h3 class="sub-heading">Google AdWords</h3>
        <h4>Art und Zweck der Verarbeitung</h4>
        ...
        <h4>Bereitstellung vorgeschrieben oder erforderlich</h4>
        <p>Die Bereitstellung Ihrer personenbezogenen Daten erfolgt freiwillig, allein auf Basis Ihrer Einwilligung. Sofern Sie den Zugriff unterbinden, kann es hierdurch zu Funktionseinschränkungen auf der Website kommen.</p>
        <h3 class="sub-heading">Einsatz von Google Remarketing</h3>
        <h4>Art und Zweck der Verarbeitung</h4>
        ...
        <h4>Bereitstellung vorgeschrieben oder erforderlich</h4>
        <p>Die Bereitstellung Ihrer personenbezogenen Daten erfolgt freiwillig, allein auf Basis Ihrer Einwilligung. Sofern Sie den Zugriff unterbinden, kann es hierdurch zu Funktionseinschränkungen auf der Website kommen.</p>
        <h3 class="sub-heading">SSL-Verschlüsselung</h3>
        <p>Um die Sicherheit Ihrer Daten bei der Übertragung zu schützen, verwenden wir dem aktuellen Stand der Technik entsprechende Verschlüsselungsverfahren (z. B. SSL) über HTTPS.</p>
        <h3 class="sub-heading">Änderung unserer Datenschutzbestimmungen</h3>
