  ...
  <main class="wrapper">
    <section 
      ...
      <article class="article article-privacy">
        <h2 class="sub-heading">Erfassung allgemeiner Informationen beim Besuch unserer Website</h2>
        ...
        <a href="#cookies">
        <h2 class="sub-heading">Cookies</h2></a>
        <h3>Art und Zweck der Verarbeitung</h3>
        ...
        <h2 class="sub-heading">Registrierung auf unserer Website</h2>
        <h3>Art und Zweck der Verarbeitung</h3>
        ...
        <h2 class="sub-heading">Erbringung kostenpflichtiger Leistungen</h2>
        <h3>Art und Zweck der Verarbeitung</h3>
        ...
        <h2 class="sub-heading">Kommentarfunktion</h2>
        <h3>Art und Zweck der Verarbeitung</h3>
